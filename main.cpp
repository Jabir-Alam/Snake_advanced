        ...
        if(u==0){
            if(p1<100){
                    if(d1==1){
                     if(done==1){ p1+=l;
      p1=a.score(p1,l);
      done=0;system("cls"); goto s1;}


                     cout<<setw(30)<<"Your score is "<<l;Sleep(500);
                     cout<<"\n\n\nPress enter to continue ";
         cin.get();
        a1=1;b1=1; d1=0;u=1;done =0;goto d2;
         }
...
a.assign(p1,p2,p3,p4);
      ...
      goto s1;
         ...
         system("cls"); goto s1;}
                     ...
                     cout<<"\n\n\nPress enter to continue ";
         cin.get();
         a1=1;b1=1;d1=0;u=2;done =0;goto d3;
         }
         if(d1==0){d1=1;
            cout<<"\n\nTurn for Player 2 \nPlease enter to roll the dice .";
s[1]=JO;
...
if(done==1){
         ...
         system("cls");goto s1;}
                     ...
                     cout<<"\n\n\nPress enter to continue ";
         cin.get();
        a1=1;b1=1; d1=0; u=3;done =0;goto d4;
         }
               if(d1==0){d1=1;cout<<"\n\nTurn for Player 3\nPlease enter to roll the dice .";
s[2]=JO;done=1;
         cin.get();
      ...
      goto s1;
        ...
        if(done==1){ p4+=l;
          ...
          system("cls");goto s1;}
                     ...
                     cout<<"\n\n\nPress enter to continue ";
         cin.get();
        a1=1;b1=1; d1=0;u=0;done =0;goto d5;
         }
            if(d1==0){d1=1; cout<<"\n\nTurn for Player 4\nPlease enter to roll the dice .";
s[3]=JO;done=1;
         cin.get();
